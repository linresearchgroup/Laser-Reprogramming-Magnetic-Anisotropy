...
!        
     ...
     +        nDim,nInt,nIntS)
      elseif(jtype.eq.7) then
         ...
         !
         nDim = 3
         call U7D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +        PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +        TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +        PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +        NJPROP,PERIOD,
     +        nDim,nInt,nIntS)
	  elseif(jtype.eq.8) then
         ...
         !
         nDim = 3
         call U8D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +        PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +        TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +        PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +        NJPROP,PERIOD,
     +        nDim,nInt,nIntS)
	  elseif(jtype.eq.9) then
         ...
         !
         nDim = 3
         call U9D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +        PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +        TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +        PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +        NJPROP,PERIOD,
     +        nDim,nInt,nIntS) 
      elseif(jtype.eq.10) then
         ...
         !
         nDim = 3
         call U10D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +        PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +        TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +        PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +        NJPROP,PERIOD,
...
************************************************************************
      ...
      subroutine U7D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +     PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +     TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +     PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +     NJPROP,PERIOD,
...
!     Internally defined variables
     ...
     +     ((coordsC(3,1)-coordsC(3,7))**two))
      ...
      do intpt=1,nIntPt
         ...
         !  all the specific forms and parameters needed for the solution
         !
         call integ7(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
         !
...
************************************************************************
      ...
      subroutine U8D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +     PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +     TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +     PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +     NJPROP,PERIOD,
...
!     Internally defined variables
     ...
     +     ((coordsC(3,1)-coordsC(3,7))**two))
      ...
      do intpt=1,nIntPt
         ...
         !  all the specific forms and parameters needed for the solution
         !
         call integ8(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
         !
...
************************************************************************
************************************************************************
      subroutine U9D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +     PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +     TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +     PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +     NJPROP,PERIOD,
...
!     Internally defined variables
     ...
     +     ((coordsC(3,1)-coordsC(3,7))**two))
      ...
      do intpt=1,nIntPt
         ...
         !  all the specific forms and parameters needed for the solution
         !
         call integ9(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
         !
...
************************************************************************
      subroutine U10D8(RHS,AMATRX,SVARS,ENERGY,NDOFEL,NRHS,NSVARS,
     +     PROPS,NPROPS,coords,MCRD,NNODE,Uall,DUall,Vel,Accn,JTYPE,
     +     TIME,DTIME,KSTEP,KINC,JELEM,PARAMS,NDLOAD,JDLTYP,ADLMAG,
     +     PREDEF,NPREDF,LFLAGS,MLVARX,DDLMAG,MDLOAD,PNEWDT,JPROPS,
     +     NJPROP,PERIOD,
...
!     Internally defined variables
     ...
     +     ((coordsC(3,1)-coordsC(3,7))**two))
      ...
      do intpt=1,nIntPt
         ...
         !  all the specific forms and parameters needed for the solution
         !
         call integ10(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
         !
...
************************************************************************
     ...
     +     half=1.d0/2.d0,nine=9.d0)
      ...
      Gshear = props(1)
      Kbulk  = props(2)
      refMagMoment(1,1) = dsqrt(3.d0)/2.d0 * props(3)
      refMagMoment(2,1) = half * props(3)
      refMagMoment(3,1) = props(5)
...
!****************************************************************************
!************************************************************************
      subroutine integ7(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
     ...
     +                      (dTRdF(i,m,k,n)*F_tau(j,m)*F_tau(l,n))/detF
      ...
      return
      end subroutine integ7	
!****************************************************************************
!************************************************************************
      subroutine integ8(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
     ...
     +                      (dTRdF(i,m,k,n)*F_tau(j,m)*F_tau(l,n))/detF
      ...
      return
      end subroutine integ8	
!****************************************************************************
************************************************************************
      subroutine integ9(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
     ...
     +                      (dTRdF(i,m,k,n)*F_tau(j,m)*F_tau(l,n))/detF
      ...
      return
      end subroutine integ9	

****************************************************************************
      subroutine integ10(props,nprops,dtime,
     +        F_tau,magFieldVec,
     +        T_tau,
     +        SpUUMod,stat)
